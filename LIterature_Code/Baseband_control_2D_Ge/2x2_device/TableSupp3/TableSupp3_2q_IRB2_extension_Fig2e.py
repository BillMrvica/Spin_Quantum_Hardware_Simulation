# this file is modified from Supp\2q_RB_all\2qRB_reorder_2023-08-22_21-41-44_CI.py
...
# reference sequence alpha  = 1.050
...
#%%
results = pickle.load( open('2q_RB_bootstrap_resample.pickle', 'rb') )['results']
...
print('')
print(' original data: 2Q Clifford avg infidelity = 0.01403')
...
print(f'-> 2Q Clifford avg infidelity = 0.01403 +- {abs(avg_err_ref_sort[9500]-avg_err_ref_sort[500])/2:.4g}, with 95% confidence interval')
# print(f'-> 2Q Clifford avg infidelity = 0.01403 +- {abs(avg_err_ref_sort[950]-avg_err_ref_sort[50])/2:.4g}, with 95% confidence interval')


print(' original data: interleaved gate avg infidelity = 0.006687')
...
print(f'-> interleaved gate avg infidelity = 0.006687 +- {abs(avg_interleaved_gate_infidelity_list[9500]-avg_interleaved_gate_infidelity_list[500])/2:.4g}, with 95% confidence interval')

# result of N_resample = 10000: 
#  original data: 2Q Clifford avg infidelity = 0.01403
# bootstrap resampling average infidelity = 0.014031
# 5% =  0.013447152928662498
# 95% =  0.014630798322750577
# -> 2Q Clifford avg infidelity = 0.01403 +- 0.0005918, with 95% confidence interval
#  original data: interleaved gate avg infidelity = 0.006687
# bootstrap resampling average infidelity = 0.0066826
# 5% =  0.00568575825230247
# 95% =  0.007673506726469492
# -> interleaved gate avg infidelity = 0.006687 +- 0.0009939, with 95% confidence interval

#   1.627 CZ + 3.21 X90 + 5.36 Z90 
# ->  X90 avg. infidelity upper bound = (0.01403 - 1.627*0.006687)/3.21 = 0.000981 +- 0.001156

# result of N_resample = 1000:
#  original data: 2Q Clifford avg infidelity = 0.01403
# bootstrap resampling average infidelity = 0.014026
# 5% =  0.013451617438001301
# 95% =  0.014600380392842865
# -> 2Q Clifford infidelity = 0.01403 +- 0.0005744, with 95% confidence interval
#  original data: interleaved gate avg infidelity = 0.006687
# bootstrap resampling average infidelity = 0.0067048
# 5% =  0.005758978760668665
# 95% =  0.00761434280161713
# -> 2Q Clifford infidelity = 0.006687 +- 0.0009277, with 95% confidence interval
...
print('')
print( 'ref sequence alpha = 1.0499 +- ' + f'{(tempvar95-tempvar05)/2:.5g}'  )
...
print( 'interleaved sequence alpha = 0.9457+- ' + f'{(tempvar95-tempvar05)/2:.5g}'  )
...
print( 'reference sequence alpha  = 1.0499 '  )
print('original data with free alpha: 2Q Clifford avg infidelity = 0.01167')
...
print(f'-> 2Q Clifford avg infidelity = 0.01167 +- {abs(val_ref_sort[int(0.95*len(avg_err_ref_list))]-val_ref_sort[int(0.05*len(avg_err_ref_list))])/2:.4g}, with 95% confidence interval')

print( 'interleaved sequence alpha = 0.9457' )
print('original data with free alpha: interleaved gate avg infidelity = 0.01355')
...
print(f'-> interleaved gate avg infidelity = 0.01355 +- {abs(val_interleaved_sort[int(0.95*len(avg_err_ref_list))]-val_interleaved_sort[int(0.05*len(avg_err_ref_list))])/2:.4g}, with 95% confidence interval')



# ref sequence alpha = 1.050 +- 0.057583
# interleaved sequence alpha = 0.9457+- 0.046821
# reference sequence alpha  = 1.050 
# original data with free alpha: 2Q Clifford avg infidelity = 0.01167
# bootstrap resampling average infidelity = 0.011699
# 5% =  0.009371648808103983
# 95% =  0.014295365651729619
# -> 2Q Clifford avg infidelity = 0.01167 +- 0.002462, with 95% confidence interval
# interleaved sequence alpha = 0.9457
# original data with free alpha: interleaved gate avg infidelity = 0.01355
# bootstrap resampling average infidelity = 0.013503
# 5% =  0.00868030601763331
# 95% =  0.018460307485208743
# -> interleaved gate avg infidelity = 0.01355 +- 0.00489, with 95% confidence interval
