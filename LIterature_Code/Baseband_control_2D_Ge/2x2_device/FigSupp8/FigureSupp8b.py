...
#%%
DEG = np.pi/180
fq2 = 3.38324710e-02*5/4 
fq3     = 7.15275643e-02*5/4    # qubit  frequency
...
# this works:
wait_q4_1=3.747 +1.94
wait_q1 = 19.33 +1.94
wait_q4_2 = 10.17  +1.94
add_wait_q1 = 9.4  +1.94
...
# filename = 'FigureSupp8b'  # 'Fig_Supp_q1x90_unequal'
...
t_x = np.cumsum(np.array([0, 23.4963,
2,
3.747,
2,
19.33,
...
plt.title('Qubit A unequal time gate voltage pulses')
plt.xlabel('time (ns)')
