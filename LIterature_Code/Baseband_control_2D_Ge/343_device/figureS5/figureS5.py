# -*- coding: utf-8 -*-
"""
Created on Mon Oct  2 17:14:41 2023
...
gates = dat.snapshot['station']['instruments']['hardware']['virtual_gates']['vgates']['real_gate_names']

virtual_gates = dat.snapshot['station']['instruments']['hardware']['virtual_gates']['vgates']['virtual_gate_names']

matrix =  dat.snapshot['station']['instruments']['hardware']['virtual_gates']['vgates']['virtual_gate_matrix']
...
#%%
#%% cropping columns
matrix_inv_del = np.delete(matrix_inv, [1, 2, 3, 5, 6, 7 , 9, 10, 11, 13, 14, 15, 38, 39, 40, 41, 42, 43, 44, 45],  1 )

#%% cropping rows
matrix_inv_del_del = np.delete(matrix_inv_del,  [1, 2, 3, 5, 6, 7 , 9, 10, 11, 13, 14, 15, 38, 39, 40, 41, 42, 43, 44, 45], 0 )

#%% cropping non-fast gates and virtual gates.
virtual_gates_del = np.delete(virtual_gates, [1, 2, 3, 5, 6, 7 , 9, 10, 11, 13, 14, 15, 38, 39, 40, 41, 42, 43, 44, 45], 0)
gates_del = np.delete(gates, [1, 2, 3, 5, 6, 7 , 9, 10, 11, 13, 14, 15, 38, 39, 40, 41, 42, 43, 44, 45], 0)


#%% final figure
fig = plt.figure(figsize = tools.cm2inch(15, 15)) #12.5 , 12.5
ax = fig.add_subplot(111)
...
if save_fig:
    ...
    file_name = f"virtual_matrix.pdf"
