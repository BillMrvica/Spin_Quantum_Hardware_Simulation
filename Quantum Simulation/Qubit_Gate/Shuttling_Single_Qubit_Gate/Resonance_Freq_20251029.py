...
ax.legend( [f'$\\theta$={phi_ins[i]} degree' for i in range(len(phi_ins))], fontsize=8, loc='upper left',bbox_to_anchor=(1.02, 1.0))
ax.set_xlabel('$\\epsilon$ (GHz)')
ax.set_ylabel('$f_{res} $ (GHz)')
